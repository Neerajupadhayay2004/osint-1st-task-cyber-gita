...
class ThreatIntelligenceService:
    ...
    async def search_breaches(self, email: str):
        try:
            ...
            breach_data = {"breached": False, "breaches": []}
            ...
            try:
                ...
                if response.status_code == 200:
                    data = response.json()
                    breach_data = {"breached": True, "breaches": data}
                elif response.status_code == 404:
                    breach_data = {"breached": False, "message": "No breaches found"}
            except Exception as e:
            ...
            domain_info = {
                ...
                "provider": "Common Provider" if domain in common_domains else "Private / Custom"
            }

            # AI Risk Score
            risk_score = 10
            if breach_data["breached"]: risk_score += 60
            if domain_info["is_disposable"]: risk_score += 25
